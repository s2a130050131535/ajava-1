...
<html>
    ...
    <body>
        <sql:setDataSource 
            ...
            url="jdbc:postgresql://localhost:5433/s2a130050131535"
            user="postgres"  
            password="byebye4842"/>
        <b>Connecting to SQL database</b><br/>
        <b>Database:s2a130050131535</b><br/>
...
<%
        ...
        <sql:update dataSource="${db}" >
            ...
            INSERT INTO SqlStudent VALUES (100, 'Bhargavi', 'Patel', 
            '2002/05/16');
            INSERT INTO SqlStudent VALUES (101, 'nidhi', 'rai', 
            '1978/11/28');
            INSERT INTO SqlStudent VALUES (102, 'aayushi', 'parikh', 
            '1980/10/10');
            INSERT INTO SqlStudent VALUES (103, 'twisha', 'purohit', 
            '1971/05/08');
