...
con = DriverManager.getConnection("jdbc:postgresql://127.0.0.1:5432/s2a130050131535","postgres","byebye4842");
ps = con.prepareStatement("SELECT * FROM student NATURAL JOIN account");
rs = ps.executeQuery();
